...
// NOTE: This class is copied from the source code. the difference: 442 line.
...
class LintGradleExecution(private val descriptor: LintExecutionRequest) {
    ...
    private fun lintAllVariants(variantNames: Set<String>) {
        ...
        if (variantNames.isNotEmpty()) {
            ...
            } else if (errorCount > 0) { // Fix: No exception will be thrown after setting the abortOnError property.
                throw GradleException("IncrementLint found $errorCount errors!")
            }
        }
    }
