...
import com.airsaid.incrementlint.IncrementFileInject
...
// NOTE: This class is copied from the source code. the difference: 273 line.
class LintGradleClient(
    ...
    override fun createLintRequest(files: List<File>): LintRequest {
        ...
        IncrementFileInject.inject(gradleProject, lintRequest)
        return lintRequest
    }
